...
#### Regressão Logística Multivariada da Taxa de Respostas
...
<br> Comparando os resultados obtidos na minha regressão com os dados apresentados na Tabela 2 do artigo, não há diferenças significantes.

#### Probabilidades preditas por grupo experimental

<br> Para a predição de probabilidades, é necessário indicar os parâmetros. Os usados nos experimentos originais são descritos na página 604 do artigo, na nota de rodapé número 16: "No primeiro experimento, os valores dessas variáveis foram: respondente mulher de 40 anos, moradora da cidade Guarujá, com ensino superior incompleto ou mais e avaliação “regular” do presidente Bolsonaro."(Avelino; Junior; Russo, 2022, p. 604) 
